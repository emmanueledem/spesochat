...
class CreateFriendView extends StatefulWidget {
  const CreateFriendView({required this.params, super.key});
  final CreateFriendViewParams params;

  @override
  State<CreateFriendView> createState() => _CreateFriendViewState();
}

class _CreateFriendViewState extends State<CreateFriendView> {
                    ...
                    SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          const Gap(10),
                          TextRegular(
                            'Please enter details to create a friend to chat.',
                            maxLines: 3,
                          ),
...
class CreateFriendViewParams {
  CreateFriendViewParams({required this.id, required this.username});
